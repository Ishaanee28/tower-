...
function setup() {
  ...
  //level one
  block17= new Block(720,155,30,40);
  block18= new Block(750,155,30,40);
  //block19=new Block(780,115,30,40);
block20=new Block(690,155,30,40);
block21= new Block(660,155,30,40);
block22= new Block(630,155,30,40);
//level two
